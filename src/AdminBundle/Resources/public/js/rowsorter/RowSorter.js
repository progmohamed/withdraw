!function (a, b) {
    ...
    function a(b, e) {
        ...
        if ("string" == typeof b && (b = c(b)), d(b, "table") === !1)throw new Error("Table not found.");
    ...
    function f(a, b) {
        for (var c = a.rows, d = c.length, e = 0; d > e; e++)if (b === c[e])return e;
        return -1
    }
    ...
    function i(a, b) {
        if (b = b.trim(), "" === b)return !1;
        if (-1 !== b.indexOf(" ")) {
            for (var c = b.replace(/\s+/g, " ").split(" "), d = 0, e = c.length; e > d; d++)if (i(a, c[d]) === !1)return !1;
            return !0
        }
    ...
    function j(a, b) {
        if (b = b.trim(), "" !== b)if (-1 === b.indexOf(" ")) i(a, b) === !1 && (a.classList ? a.classList.add(b) : a.className += " " + b); else for (var c = b.replace(/\s+/g, " ").split(" "), d = 0, e = c.length; e > d; d++)j(a, c[d])
    }

    function k(a, b) {
        if (b = b.trim(), "" !== b)if (-1 === b.indexOf(" ")) i(a, b) && (a.classList ? a.classList.remove(b) : a.className = a.className.replace(new RegExp("(\\s|^)" + b + "(\\s|$)"), " ")); else for (var c = b.replace(/\s+/g, " ").split(" "), d = 0, e = c.length; e > d; d++)k(a, c[d])
    }

    function l(a, b) {
        if (p)return p.extend({}, a, b);
        var c, d = {};
        for (c in a)a.hasOwnProperty(c) && (d[c] = a[c]);
        if (b && "[object Object]" === Object.prototype.toString.call(b))for (c in b)b.hasOwnProperty(c) && (d[c] = b[c]);
        return d
    }
    ...
    var p = window.jQuery || !1, q = !!("ontouchstart" in document), r = "data-rowsorter", s = {
        handler: null,
        tbody: !0,
    ...
    return a.prototype.init = function () {
        ...
        if (this._options.handler) {
            ...
            if (!c || -1 === o(a, c))return !1
        }
        var d = n(a, "tr"), e = f(this._tbody, d);
        ...
        if (null !== this._lastSort) {
            var a = this._lastSort, b = a.oldIndex, c = a.newIndex, d = this._tbody.rows, e = d.length - 1;
        ...
        var d = b(a);
        if (null === d && c === !1)throw new Error("Table not found.");
        d && d.revert()
